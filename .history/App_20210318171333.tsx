...
const App = () => {
	...
	const [stateGranted, setStateGranted] = useState(null);
	...
	const requestPhoneStatePermission2 = async () => {
		try {
			const granted = await PermissionsAndroid.request(
				PermissionsAndroid.PERMISSIONS.PROCESS_OUTGOING_CALLS,
				{
					title: 'Cool PROCESS_OUTGOING_CALLS Permission',
					message:
						'Listener needs access to your PROCESS_OUTGOING_CALLS',
					buttonNeutral: 'Ask Me Later',
					buttonNegative: 'Cancel',
					buttonPositive: 'OK'
				}
			...
			if (granted === PermissionsAndroid.RESULTS.GRANTED) {
				setStateGranted(PermissionsAndroid.RESULTS.GRANTED)
				console.log('You can use the PROCESS_OUTGOING_CALLS');
			} else {
				console.log('PROCESS_OUTGOING_CALLS permission denied');
			}
		} catch (err) {
			console.warn(err);
		}
	...
	return (
		<SafeAreaView style={{ flex: 1, paddingTop: 30 }}>
			...
			<View style={styles.item}>
				<Text>Try permissions</Text>
				<Button title='request permissions2' onPress={requestPhoneStatePermission2} />
			</View>
